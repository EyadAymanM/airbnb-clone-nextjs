  ...
  return (
    <>
        <div className='container mx-auto px-20'>
            <h1 className="mb-20 mt-10 text-4xl font-bold tracking-tight text-gray-700 dark:text-white" >Travel for work</h1>
            <div className='flex justify-between mb-20'>
                <div className=' mb-20 '>
                    <p className=" mt-10 text-2xl font-bold tracking-tight text-gray-700 dark:text-white" >Join Airbnb for Work</p>
                    <p className=" mt-10 text-1xl  tracking-tight text-gray-900 dark:text-white" >Add your work email to get seamless expensing and exclusive offers on work trips.</p>
                    <div className='w-full'>
                        <form className="w-full max-w-lg">
                          <label className='font-bold text-gray-700'>Work email address</label>
                          <div className="   mb-10">
                            <input className="outline-none border-b border-gray-300 appearance-none bg-transparent text-3xl  w-full rounded  text-gray-500 mr-3 py-1 px-2 leading-tight focus:outline-none" type="email" placeholder=""  aria-label="Full name" />
                          </div>
                          <button
                            type="button"
                            class="inline-block rounded bg-gray-900 px-6 pb-2 pt-2.5 text-xs font-medium uppercase leading-normal text-white shadow-primary-3 transition duration-150 ease-in-out hover:bg-primary-accent-300 hover:shadow-primary-2 focus:bg-primary-accent-300 focus:shadow-primary-2 focus:outline-none focus:ring-0 active:bg-primary-600 active:shadow-primary-2 motion-reduce:transition-none dark:shadow-black/30 dark:hover:shadow-dark-strong dark:focus:shadow-dark-strong dark:active:shadow-dark-strong">
                            Add work email
                          </button>
                        </form>
                    </div>
                </div>
                <div className="  w-80 max-w-md  bg-white border border-gray-200  rounded-lg shadow sm:p-8 dark:bg-gray-800 dark:border-gray-700">
                        <div className=''>
                          ...
                          <p className="mb-5 text-gray-800 text-2xl font-bold">Simplified expensing</p>
                          <p className="mb-5 text-gray-500">We’ll send work trip receipts to your work inbox for easy expensing.</p>
                        </div>
                        <div>
                          ...
                          <p className="mb-5 text-gray-800 text-2xl font-bold"> Trip description</p>
                          <p className="mb-5 text-gray-500"> Add an expense code and business purpose to work trip</p>
                        </div>
                        <div>
                          ...
                          <p className="mb-5 text-gray-800 text-2xl font-bold">Keep personal trips private</p>
                          <p className="mb-5 text-gray-500">Your company can only get info about trips you mark for work at checkout.</p>
                        </div>
                </div>
            </div>
        </div>
