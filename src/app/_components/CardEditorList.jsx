...
const CardEditorList = ({ listing = {}, onCardClick, mobile }) => {
  ...
  const cardData = [
    {
      title: t("photo-tour"),
      description: t("photo-tour-description"),
      route: "photo-tour",
    },
    {
      title: t("title"),
      description: listing.title || t("no-title-available"),
      route: "title",
    },
    {
      title: t("description"),
      description: listing.description
        ? `${listing.description.slice(0, 25)}${
            listing.description.length > 25 ? "..." : ""
          }`
    ...
    },
    {
      ...
      description: listing.type || t("no-category"),
      route: "property-type",
    },
    {
      title: t("pricing"),
    ...
    },
    {
      ...
      description: listing.guests
        ? `${listing.guests} ${t("guests")}`
        : t("no-guests-info"),
      route: "number-of-guests",
    },
    {
      title: t("amenities"),
      description:
        listing.amenities
          ?.map((amenity) =>
            locale === "en" ? amenity.name.en : amenity.name.ar
          )
          .join(", ") || t("no-amenities"),
      route: "amenities",
    },
