...
export default function infoReviews() {
  const reviewData = [
    {
      reviewer: "Fouad",
      img: "https://a0.muscache.com/im/pictures/user/1c4ff44a-fd16-4c9b-b224-c2eb3ea07a76.jpg?im_w=240",
      rating: 5,
      comment:
        "The place was amazing! Everything was clean and well-maintained.",
    },
    {
      reviewer: "Eyad",
      img: "https://a0.muscache.com/im/pictures/user/1c4ff44a-fd16-4c9b-b224-c2eb3ea07a76.jpg?im_w=240",
      rating: 4,
      comment: "Great location, but a bit noisy at night. Overall a nice stay.",
    },
    {
      reviewer: "Mostafa",
      img: "https://a0.muscache.com/im/pictures/user/1c4ff44a-fd16-4c9b-b224-c2eb3ea07a76.jpg?im_w=240",
      rating: 5,
      comment:
        "Highly recommended! The host was very helpful and the house is perfect.",
    },
    {
      reviewer: "Abeer",
      img: "https://a0.muscache.com/im/pictures/user/1c4ff44a-fd16-4c9b-b224-c2eb3ea07a76.jpg?im_w=240",
      rating: 4,
      comment: "The apartment was spacious, but the check-in process was slow.",
    },
    {
      reviewer: "hafez",
      img: "https://a0.muscache.com/im/pictures/user/1c4ff44a-fd16-4c9b-b224-c2eb3ea07a76.jpg?im_w=240",
      rating: 5,
      comment:
        "Cleanliness is top-notch, and the location is great for exploring the city.",
    },
    {
      reviewer: "Hoor",
      img: "https://a0.muscache.com/im/pictures/user/1c4ff44a-fd16-4c9b-b224-c2eb3ea07a76.jpg?im_w=240",
      rating: 5,
      comment:
        "The communication with the host was excellent, and the place was cozy.",
    },
  ];
  ...
  return (
    <>
      <Dialog>
        <DialogTrigger>
          <div className="flex border rounded-lg items-center justify-around h-24">
            <div className="flex mx-4 items-center">
              <svg
                ...
                height="45"
              >
                <g clipRule="url(#clip0_5880_37773)">
                  <path
                    fillRule="evenodd"
                    clipRule="evenodd"
              ...
              <svg
                ...
                height="45"
              >
                <g clipRule="url(#clip0_5880_37786)">
                  <path
                    fillRule="evenodd"
                    clipRule="evenodd"
              ...
              <div className="flex">
                {[...Array(5)].map((_, index) => (
                  <svg
                    ...
                    fill="currentColor"
                    className={`w-4 h-4 ${
                      index > 4.94 ? "text-yellow-500" : "text-gray-800"
                    }`}
                  >
                    <path
                      fillRule="evenodd"
            ...
            <div className="flex flex-col items-center mx-4">
              <div className="text-xl font-bold">{reviewData.length}</div>
              <div className="text-md font-semibold">Review</div>{" "}
            </div>
          </div>
        </DialogTrigger>
        ...
        <DialogContent className="sm:max-w-[425px] md:max-w-[600px] lg:max-w-[800px] max-h-[500px] overflow-y-auto ">
          <DialogHeader className="flex justify-center items-center ">
            ...
            <DialogDescription className="text-center">
              <h2 className="font-bold text-black">Guest Favorite</h2>
