...
const messageSettings = [
  {
    ...
    icon: <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 24 24" fill="none">
      <path d="M11 4H7.8C6.11984 4 5.27976 4 4.63803 4.32698C4.07354 4.6146 3.6146 5.07354 3.32698 5.63803C3 6.27976 3 7.11984 3 8.8V14C3 14.93 3 15.395 3.10222 15.7765C3.37962 16.8117 4.18827 17.6204 5.22354 17.8978C5.60504 18 6.07003 18 7 18V20.3355C7 20.8684 7 21.1348 7.10923 21.2716C7.20422 21.3906 7.34827 21.4599 7.50054 21.4597C7.67563 21.4595 7.88367 21.2931 8.29976 20.9602L10.6852 19.0518C11.1725 18.662 11.4162 18.4671 11.6875 18.3285C11.9282 18.2055 12.1844 18.1156 12.4492 18.0613C12.7477 18 13.0597 18 13.6837 18H15.2C16.8802 18 17.7202 18 18.362 17.673C18.9265 17.3854 19.3854 16.9265 19.673 16.362C20 15.7202 20 14.8802 20 13.2V13M20.1213 3.87868C21.2929 5.05025 21.2929 6.94975 20.1213 8.12132C18.9497 9.29289 17.0503 9.29289 15.8787 8.12132C14.7071 6.94975 14.7071 5.05025 15.8787 3.87868C17.0503 2.70711 18.9497 2.70711 20.1213 3.87868Z" stroke="#000000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
    </svg>
  },
  {
    title: "Star",
  ...
  {
    title: "Archive",
    icon: <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 25 25" fill="none">
...
const messages = [
  {
    ...
    type:'sender',
    content:"Hi Eyad, I was checking if the listing is still available for reservation?",
  ...
  return (
    <>
      <div className="flex flex-col border-b border-[#ededed]" onMouseEnter={hoverOver} onMouseLeave={hoverOut}>
        <Dialog>
          ...
          <DialogContent className="bg-white border rounded-xl p-0 h-[90vh] max-w-[36%]">
            <DialogHeader>
              <DialogTitle className="text-center mb-4 mt-5">Messaging settings</DialogTitle>
              <DialogDescription className="p-0">
                <ul className="">
                  <h1 className="px-12 text-2xl font-medium">Conversation actions</h1>
      ...
      <div className="pt-8 flex flex-col grow  overflow-y-scroll relative">
        <h1 className="text-[#666] text-[14px] text-center font-airbnb ">Today</h1>
        <div className="grow">
        ...
        <div className="flex w-full px-8 bg-white sticky bottom-0 pb-5 pt-3 items-center">
          ...
          <form className="grow">
            <input type="search" id="search" className="w-full block w- p-2 py-2 ps-11 text-sm text-gray-900 border border-gray-300 rounded-full bg-gray-50 focus:border-none" placeholder="Type a message" />
          </form>
        </div>
